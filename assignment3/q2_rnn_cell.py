...
class RNNCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            W_x = tf.get_variable(name="W_x", shape=(self.input_size, self.state_size), initializer=tf.glorot_uniform_initializer())
            W_h = tf.get_variable(name="W_h", shape=(self.state_size, self.state_size), initializer=tf.glorot_uniform_initializer())
            b = tf.get_variable(name="b", shape=(self.state_size), initializer=tf.zeros_initializer)
